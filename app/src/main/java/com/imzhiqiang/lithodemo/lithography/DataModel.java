...
public class DataModel {
    ...
    private static Datum[] SampleData() {
        return new Datum[] {
                new Decade(1800), new Artist("Richard James Lane",
                "Lithographer to Queen Victoria and Prince Albert, Lane produced over a "
                        ...
                        + "of a eighteen year old Queen Victoria.", 1800,
                "https://upload.wikimedia.org/wikipedia/commons/3/33/George_Francis_Lyon.jpg"),
                new Artist("Louis and Fritz Wolff",
                ...
                new Decade(1810), new Artist("\u00C9mile Lassalle",
                ...
                "The renowned post-impressionist painter dabbled briefly in lithography, "
                        ...
                        + "Eternity's Gate\" he also captured in other media.", 1853,
                ...
                new Artist("Juan Comba Garc\u00EDa", //Garcia
                        "A Spanish cartoonist, photographer and painter, Juan Comba Garc\u00EDa "
                                ...
                                + "683 graphic works during the time of King Alfonso XII.", 1854,
    ...
    public static void populateBinderWithSampleData(RecyclerBinder recyclerBinder,
            ComponentContext c) {
        ...
        for (Datum datum : dataModels) {
            ...
            recyclerBinder.insertItemAt(recyclerBinder.getItemCount(),
